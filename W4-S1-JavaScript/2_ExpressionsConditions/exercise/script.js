...
let symbolA = "す"; // U+3059
let symbolB = "ず"; // U+305A
let numSymbol = 0;
numSymbol = Number(symbolA);

console.log(`The symbol that is greater is ${(symbolA > symbolB)? symbolA : symbolB}`);

console.log(`The value of symbolA is ${numSymbol} `);
